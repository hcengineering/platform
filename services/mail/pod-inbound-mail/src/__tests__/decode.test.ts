...
describe('decodeContent', () => {
  test('should return original content when encoding is undefined', () => {
    ...
    const result = decodeContent(content, undefined)
  ...
  test('should decode base64 content', () => {
    ...
    const result = decodeContent(base64Content, 'base64')
  ...
  test('should decode quoted-printable content', () => {
    ...
    const result = decodeContent(qpContent, 'quoted-printable')
    expect(result).toBe('Hello World!')
  })
