...
describe('SyncManager', () => {
  ...
  describe('getHistory', () => {
    it('should retrieve history from key-value store', async () => {
      ...
      // Assert
      expect(mockKeyValueClient.getValue).toHaveBeenCalledWith('gmail', `history:${workspace}:${userId}`)
  ...
  describe('setHistoryId', () => {
    it('should store history in key-value store', async () => {
      ...
      // Assert
      expect(mockKeyValueClient.setValue).toHaveBeenCalledWith('gmail', `history:${workspace}:${userId}`, {
        historyId,
        userId,
        workspace
      })
  ...
  describe('clearHistory', () => {
    it('should delete history from key-value store', async () => {
      ...
      // Assert
      expect(mockKeyValueClient.deleteKey).toHaveBeenCalledWith('gmail', `history:${workspace}:${userId}`)
    })
  })
