  ...
  builder.createDoc(view.class.Viewlet, core.space.Model, {
    ...
    config: [
      ...
      { key: '', presenter: tracker.component.DueDatePresenter, props: { kind: 'list' } },
      {
        ...
        props: { kind: 'list', size: 'small', shape: 'round', shouldShowPlaceholder: false, excludeByKey: 'project' }
      },
      {
        key: '',
        presenter: tracker.component.SprintEditor,
        props: { kind: 'list', size: 'small', shape: 'round', shouldShowPlaceholder: false, excludeByKey: 'sprint' }
      },
