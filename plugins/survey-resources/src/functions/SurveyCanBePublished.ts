...
export const SurveyCanBePublished: ViewActionAvailabilityFunction<Survey> = async (
  ...
  return (Array.isArray(objects) ? objects : [objects]).every((object) => {
    return object.private && object.questions > 0 && object.createdBy === currentAccountId && object.results === 0
  })
}
