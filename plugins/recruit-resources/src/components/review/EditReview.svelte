...
import Review from '../icons/Review.svelte'
  ...
  onMount(() => {
    dispatch('open', { ignoreKeys: ['comments', 'number', 'description'] })
  })
</script>
{#if object !== undefined && candidate !== undefined}
  ...
  <div class='description flex'>
    <StyledTextBox content={object.description}  on:value={(evt) => {
  ...
  <div class='description flex'>
    <StyledTextBox content={object.verdict}  on:value={(evt) => {
