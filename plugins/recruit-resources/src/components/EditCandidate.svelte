...
<script lang="ts">
  ...
  import { AttributeEditor, Avatar, Channels, createQuery, getClient } from '@anticrm/presentation'
  import type { Candidate } from '@anticrm/recruit'
  import { AnyComponent, CircleButton, EditBox, IconAdd, Label, showPopup } from '@anticrm/ui'
