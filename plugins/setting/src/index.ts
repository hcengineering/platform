...
export default plugin(settingId, {
  ...
  string: {
    ...
    AccountPermissionsSettings: '' as IntlString,
    AccountPermissionsModuleAccess: '' as IntlString,
    AccountPermissionsModuleAccessHint: '' as IntlString,
    AccountPermissionsModulePermissions: '' as IntlString,
    AccountPermissionsAllowedPermissions: '' as IntlString,
    AccountPermissionsAllowedPermissionsHint: '' as IntlString,
