<script lang="ts">
  ...
  import { Issue, IssueStatus, Team } from '@anticrm/spuristo'
...
<Scroller>
  <Table
    _class={spuristo.class.Issue}
    config={[
      { key: '', presenter: spuristo.component.IssuePresenter, props: { currentTeam }, label: spuristo.string.Issue },
      'title',
      // 'status',
      '$lookup.assignee',
      'modifiedOn'
