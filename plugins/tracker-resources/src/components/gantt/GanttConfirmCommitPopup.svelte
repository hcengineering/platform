...
<script lang="ts">
   ...
   * server write. It is easy to mis-grab an issue
...
<style lang="scss">
  .confirm-popup {
    ...
    padding: 16px;
    /*
     * Mobile-friendly Gantt, confirm-popup layout:
     * The previous fixed 600 px popups overflow a 320 px screen. We constrain
