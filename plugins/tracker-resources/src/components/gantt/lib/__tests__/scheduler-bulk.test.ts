 ...
 * capable. These tests pin the contract that the bulk-drag
 * code path relies on: a single cascade pass, and a successor shared by
 * several primaries is moved exactly once, by the largest delta.
 */
