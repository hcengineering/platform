...
import { snapToUtcMidnight } from '@hcengineering/gantt'
 ...
 * the canvas immediately — dates are day-granular, so a one-day bar is the
 * smallest thing that can be drawn.
 *
