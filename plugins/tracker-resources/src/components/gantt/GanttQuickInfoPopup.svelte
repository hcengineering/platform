...
<script lang="ts">
  ...
  /**
   * Lightweight popover surfaced by single-click on a Gantt bar
...
<div class="quick-info antiPopup">
  ...
  <!-- The quick-info popover surfaces Status / Priority / Assignee /
       Estimation. Reuses the existing EstimationEditor from
