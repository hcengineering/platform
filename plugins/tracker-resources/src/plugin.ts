...
export default mergeIds(trackerId, tracker, {
  ...
  string: {
    ...
    TimeReports: '' as IntlString,
    TeamTimeReport: '' as IntlString,
    TimeReportsFilterTask: '' as IntlString,
    TimeReportsFilterTaskSearch: '' as IntlString,
    TimeReportsAddTask: '' as IntlString,
    TimeReportsClearTasks: '' as IntlString,
    TimeReportsFilterReporter: '' as IntlString,
    TimeReportsFilterAssignees: '' as IntlString,
    TimeReportsFilterTracker: '' as IntlString,
    TimeReportsDates: '' as IntlString,
    TimeReportsWithRecordedTime: '' as IntlString,
    TimeReportsAllTasks: '' as IntlString,
    TimeReportsColumnAssignees: '' as IntlString,
    TimeReportsTitle: '' as IntlString,
    TimeReportsEmpty: '' as IntlString,
    TimeReportsOfMembers: '' as IntlString,
    TimeReportsPrevPage: '' as IntlString,
    TimeReportsNextPage: '' as IntlString,
    TimeReportsExportExcel: '' as IntlString,
    TimeReportsExportColIssueId: '' as IntlString,
    TimeReportsExportColIssueTitle: '' as IntlString,
    TimeReportsExportColParentId: '' as IntlString,
    TimeReportsExportColParentTitle: '' as IntlString,
    TimeReportsExportColReporter: '' as IntlString,
    TimeReportsExportColHours: '' as IntlString,
    TimeReportsExportTotal: '' as IntlString,
  ...
  component: {
    ...
    ProjectTimeReports: '' as AnyComponent,
