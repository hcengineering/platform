...
export default mergeIds(trackerId, tracker, {
  ...
  string: {
    ...
    SetDependency: '' as IntlString,
    ChangeDependency: '' as IntlString,
    RemoveDependency: '' as IntlString,
    OpenDependency: '' as IntlString,
  ...
  component: {
    ...
    SetDependencyIssueActionPopup: '' as AnyComponent,
