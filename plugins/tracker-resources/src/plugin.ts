...
export default mergeIds(trackerId, tracker, {
  ...
  string: {
    ...
    AdditionalAccess: '' as IntlString,
    SpaceMembersAccess: '' as IntlString,
    NoAdditionalAccess: '' as IntlString,
    GrantedViaMention: '' as IntlString,
    GrantedManually: '' as IntlString,
    GrantedViaGroup: '' as IntlString,
    GrantedByOn: '' as IntlString,
    RevokeAccess: '' as IntlString,
    GiveUpAccess: '' as IntlString,
    AddPersonAccess: '' as IntlString,
    LevelRead: '' as IntlString,
    LevelWrite: '' as IntlString,
    LevelAdmin: '' as IntlString,
    AccessLevelLabel: '' as IntlString,
    GrantAccessTitle: '' as IntlString,
