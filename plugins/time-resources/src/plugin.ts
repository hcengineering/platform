...
export default mergeIds(timeId, time, {
  ...
  string: {
    ...
    UrgentPriorityShort: '' as IntlString,
    HighPriorityShort: '' as IntlString,
    MediumPriorityShort: '' as IntlString,
    LowPriorityShort: '' as IntlString,
    NoPriorityShort: '' as IntlString,
