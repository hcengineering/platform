...
export default mergeIds(chunterId, chunter, {
  ...
  string: {
    ...
    FileBrowserDateFilter0: '' as IntlString,
    FileBrowserDateFilter1: '' as IntlString,
    FileBrowserDateFilter2: '' as IntlString,
    FileBrowserDateFilter3: '' as IntlString,
    FileBrowserDateFilter4: '' as IntlString,
    FileBrowserDateFilter5: '' as IntlString,
    FileBrowserDateFilter6: '' as IntlString,
    FileBrowserTypeFilter0: '' as IntlString,
    FileBrowserTypeFilter1: '' as IntlString,
    FileBrowserTypeFilter2: '' as IntlString,
    FileBrowserTypeFilter3: '' as IntlString,
    FileBrowserTypeFilter4: '' as IntlString,
