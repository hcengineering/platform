...
export class ContractPage {
  ...
  readonly employeeNavElement = (Employee: string): Locator => this.page.locator(`.antiNav-element:has-text("${Employee}")`)
  ...
  readonly employeeEntry = (first: string, last: string): Locator => this.page.locator(`td:has-text("${last} ${first}")`)
  ...
  readonly newApplicationChooseRecruiter = (recruiter: string): Locator => this.page.getByRole('button', { name: recruiter })
