...
export class DocumentsPage extends CommonPage {
    ...
    readonly buttonCreateDocument = (): Locator => this.page.locator('div[data-float="navigator"] button[id="new-document"]');
    ...
    readonly inputModalNewTeamspaceTitle = (): Locator => this.formNewTeamspace().locator('div[id="teamspace-title"] input');
    readonly inputModalNewTeamspaceDescription = (): Locator => this.formNewTeamspace().locator('div[id="teamspace-description"] input');
    ...
    readonly buttonModalEditTeamspaceTitle = (): Locator => this.formEditTeamspace().locator('div[id="teamspace-title"] input');
    readonly buttonModalEditTeamspaceDescription = (): Locator => this.formEditTeamspace().locator('div[id="teamspace-description"] input');
    readonly buttonModalEditTeamspacePrivate = (): Locator => this.formEditTeamspace().locator('div.antiGrid label.toggle');
    ...
    async clickOnButtonCreateDocument() {
