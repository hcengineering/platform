...
export class RecruitingPage {
  ...
  readonly searchOrRunCommandInput = (): Locator => this.page.locator('[placeholder="Search\\ or\\ run\\ a\\ command\\.\\.\\."]')
  readonly newTalentPopupOption = (): Locator => this.page.locator('div.selectPopup :text("New Talent")')
  readonly goToVacanciesPopupOption = (): Locator => this.page.locator('div.selectPopup div.list-item :text("Go To Vacancies")')
