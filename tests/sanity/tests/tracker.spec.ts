...
test('my-issues', async ({ page }) => {
  ...
  await page.click('text=Assigned Created Subscribed >> div >> nth=0')
  await expect(page.locator('.antiPanel-component')).not.toContainText(name)
  await page.click('text=Assigned Created Subscribed >> div >> nth=1')
  await expect(page.locator('.antiPanel-component')).toContainText(name)
  await page.click('text=Assigned Created Subscribed >> div >> nth=2')
  await expect(page.locator('.antiPanel-component')).toContainText(name)
