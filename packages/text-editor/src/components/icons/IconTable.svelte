<script lang="ts">
  ...
  export let style: 'table' | 'grid' | 'tableProps' | 'addRow' = 'table'
...
{:else if style === 'addRow'}
  <svg class="svg-{size}" {fill} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M20.6,14.7H3.5c-1,0-1.8,0.8-1.8,1.7v4.1c0,1,0.8,1.8,1.8,1.8h17.1c1,0,1.8-0.8,1.8-1.8v-4.1C22.3,15.5,21.5,14.7,20.6,14.7z M14.2,16.2v4.6h-5v-4.6H14.2z M3.2,20.3v-3.6c0-0.3,0.2-0.5,0.5-0.5h4v4.6h-4C3.4,20.8,3.2,20.6,3.2,20.3z M20.8,20.3c0,0.3-0.2,0.5-0.5,0.5h-4.6v-4.6h4.6c0.3,0,0.5,0.2,0.5,0.5V20.3z"
      fill-rule="evenodd"
      clip-rule="evenodd"
    />
    <path
      d="M10.9,4.6c0,0,0-0.1,0-0.1c0,0,0-0.1,0-0.1c0,0,0,0,0,0c0,0,0,0-0.1-0.1c0,0-0.1-0.1-0.1-0.1c0,0-0.1-0.1-0.1-0.1c0,0-0.1,0-0.1-0.1c0,0-0.1,0-0.2,0c0,0-0.1,0-0.1,0H6.5c-0.4,0-0.8,0.3-0.8,0.7c0,0.4,0.3,0.8,0.8,0.8h1.4c-2.1,2-3.5,4.8-3.5,7.9c0,0.4,0.3,0.8,0.8,0.8c0.4,0,0.8-0.3,0.8-0.8c0-2.9,1.4-5.5,3.5-7.2v2.2c0,0.4,0.3,0.8,0.8,0.8c0.4,0,0.7-0.3,0.7-0.8L10.9,4.6C10.9,4.7,10.9,4.7,10.9,4.6z"
      fill-rule="evenodd"
      clip-rule="evenodd"
    />
    <path
      d="M19.6,8.2h-2.2V6c0-0.4-0.3-0.8-0.8-0.8S15.8,5.5,15.8,6v2.3h-2.2c-0.4,0-0.8,0.3-0.8,0.8s0.3,0.8,0.8,0.8h2.2V12c0,0.4,0.3,0.8,0.8,0.8s0.8-0.3,0.8-0.8V9.7h2.2c0.4,0,0.8-0.3,0.8-0.8S20,8.2,19.6,8.2z"
      fill-rule="evenodd"
      clip-rule="evenodd"
    />
  </svg>
