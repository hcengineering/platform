...
export default plugin(coreId, {
  ...
  string: {
    ...
    ForbidCreateObject: '' as IntlString,
    ForbidUpdateObject: '' as IntlString,
    ...
    ForbidCreateObjectDescription: '' as IntlString,
    ForbidUpdateObjectDescription: '' as IntlString,
  ...
  permission: {
    ...
    ForbidCreateObject: '' as Ref<Permission>,
    ForbidUpdateObject: '' as Ref<Permission>,
