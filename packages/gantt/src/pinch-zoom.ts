 ...
 *   - Zoom anchor = midpoint between the two fingers AT pinch-start.
 ...
 * [MIN_PPD, MAX_PPD] range that Ctrl+Wheel-zoom uses: the finger distance
 * delta maps onto a px-per-day ratio exactly like a wheel delta does, so
 * touch and mouse zoom end up at the same scale.
 *
