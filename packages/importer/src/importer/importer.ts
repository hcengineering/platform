...
export interface ImportProject extends ImportSpace<ImportIssue> {
  ...
  description?: string
  // Declarative components + milestones associated with
...
export interface ImportIssue extends ImportDoc {
  ...
  // Gantt-scheduling fields. Dates are UTC midnight epoch
  // ms; HulyFormatImporter parses YYYY-MM-DD inputs.
  startDate?: number
  dueDate?: number
  // Soft deadline; renders a flag marker in the Gantt.
  deadline?: number
  ...
  // Finish-to-start dependency list. Each entry is a
